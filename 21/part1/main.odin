...
main :: proc() {
	...
	for food in foods {
		outer1: for ingredient in food.ingredients {
			for allergen, allergen_ingredient in allergens {
				if strings.equal_fold(allergen_ingredient, ingredient) {
					continue outer1
				}
			}
			safe_counter += 1
